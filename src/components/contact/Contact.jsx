...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_mp4f78f', 'template_720rqpk', form.current, {
        publicKey: '8d6qjZQVk4G3YwO_X',
      })
      e.target.reset()
  };
  return (
    <section className="contact section" id="contact">
        ...
        <div className="contact__container container grid">
          <div className="contact__content">
            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <span className="contact__card-data">harshithc890@gmail.com</span>

                <a href="mailto:harshithc890@gmail.com.com" className="contact__button">Write to me 
              ...
              <div className="contact__card">
                ...
                <span className="contact__card-data">+91-9901177605</span>

                <a href="https://api.whatsapp.com/send?%20phone=%20%229901177605%22%20&text=Hello,%20more%20information!" className="contact__button">Write to me 
                  <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
              </div>
            </div>
          </div>
          ...
          <div className="contact__content">
            <h3 className="contact__title">Drop a mail</h3>
            ...
            <form ref={form} onSubmit={sendEmail} className="contact__form">
              ...
              <button className="button button--flex">
                Send Message
                <svg 
                xmlns="http://www.w3.org/2000/svg" class="button__icon" width="24" height="24" viewBox="0 0 24 24" fill="none">
